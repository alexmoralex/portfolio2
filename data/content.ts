...
const content: Content = {
  en: {
    ...
    home: {
      ...
      title2: 'Shopify Expert',
    },
    work: {
      companiesTitle: 'I have worked for these companies',
    ...
    about: {
      ...
      paragraph5: 'This is the latest design of my website,',
      contactButton: 'Contact me',
      workButton: 'Check my work',
      portfolioButton: 'See previous design',
    },
    contact: {
      email: 'Email',
      name: 'Name',
  ...
  es: {
    ...
    home: {
      title1: 'Desarrollador Fullstack',
      title2: 'Experto Shopify',
    },
    work: {
      companiesTitle: 'He trabajado para estas compañías',
    ...
    about: {
      ...
      paragraph5: 'Este es el ultimo diseño de mi sitio web,',
      contactButton: 'Contactame',
      workButton: 'Revisa mi trabajo',
      portfolioButton: 'Ver diseño previo',
    },
    contact: {
      email: 'Email',
      name: 'Nombre',
  ...
  fr: {
    ...
    home: {
      ...
      title2: 'Spécialiste Shopify',
    },
    work: {
      companiesTitle: 'J’ai travaillé pour ces entreprises',
    ...
    about: {
      ...
      paragraph5: 'Ceci est la dernière conception de mon site Web,',
      contactButton: 'Contactez moi',
      workButton: 'Regardez mon travail',
      portfolioButton: 'Voir la conception précédente',
    },
    contact: {
      email: 'Email',
      name: 'Nom',
